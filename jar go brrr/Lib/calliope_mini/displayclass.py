# displayclass.py
# Version 1.07 - Apr 1, 2020

from calliope_mini import _sim, _ledSize, pixfont, image
import time
...
# ColorLed
    ...
    def _setRGB(self):
        self.set_colors(self._ledR, self._ledG, self._ledB)
    ...
    def get_colors(self):
        return (self._ledR, self._ledG, self._ledB)   
